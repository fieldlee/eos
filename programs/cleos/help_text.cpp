...
const char* error_advice_name_type_exception = R"=====(Name should be less than 16 characters and only contains the following symbol .12345abcdefghijklmnopqrstuvwxyz)=====";
